...
Patch47: binutils-rh676194.patch
Patch48: binutils-rh739144.patch
Patch49: binutils-rh809616.patch
Patch50: binutils-rh739144-2.patch
Patch51: binutils-rh825736.patch
Patch52: binutils-rh773526.patch
Patch53: binutils_rh870125.patch
Patch54: binutils-rh906079.patch
Patch55: binutils-rh909056.patch
Patch56: binutils-rh870125.patch
Patch57: binutils-rh959422.patch
...
* Thu Apr 24 2014 Patsy Franklin <pfrankli@redhat.com> - 2.20.51.0.2-5.41
- Add check for debugging section in LD to LE linker relaxation 
  for R_390_TLS_LDO32. (#959422)

* Wed Apr 9 2014 Jeff Law <law@redhat.com> - 2.20.51.0.2-5.40
- Fix up manpage for assembler (#870125)

* Wed Apr 9 2014 Jeff Law <law@redhat.com> - 2.20.51.0.2-5.39
- Do not install windmc(1) man page (#850832)

* Mon Apr 7 2014 Jeff Law <law@redhat.com> - 2.20.51.0.2-5.38
- Use thread-safe PLT stubs for Power. (#906079)
- Avoid segfault when arch member uses long names, but no longname
  table exists.  (#909056)
- Correct patch for 773526. (#922393)

* Tue Jul 23 2013 Patsy Franklin <pfrankli@redhat.com> - 2.20.51.0.2-5.37
- Change 'as' man page to correctly describe the -v option.(#870125)

* Mon Sep 17 2012 Patsy Franklin <pfrankli@redhat.com> - 2.20.51.0.2-5.36
- Fix readelf display of multibyte characters in ELF header.(#773526)

* Fri Aug 10 2012 Nick Clifton <nickc@redhat.com> - 2.20.51.0.2-5.35
- Fix the creation of GNU_RELRO segments (#825736)

* Tue May  8 2012 Nick Clifton <nickc@redhat.com> - 2.20.51.0.2-5.34
- Install corrected patch (#739144)

* Thu Apr 5 2012 Nick Clifton <nickc@redhat.com> - 2.20.51.0.2-5.33
- Do not scan empty sections when computing a build-id (#809616)

* Mon Mar 5 2012 Jeff Law <law@redhat.com> - 2.20.51.0.2-5.32
- Remove duplicate bextr insn (#739444)

* Wed Feb 22 2012 Nick Clifton <nickc@redhat.com> - 2.20.51.0.2-5.31
- PowerPC TOC and PLT optimizations (#739144)
- Fix compilation of linker tests

* Fri Jan 20 2012 Nick Clifton <nickc@redhat.com> - 2.20.51.0.2-5.30
- Fix typo in new linker test (#676194)

* Thu Jan 19 2012 Nick Clifton <nickc@redhat.com> - 2.20.51.0.2-5.29
- Fix linking mixed architecture object files (#676194)

* Mon Oct 24 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.28
- Fix lost addend (#747695)

* Tue Aug 30 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.27
- Fix PowerPC64 toc edit fail (#733122)

* Wed Jul 27 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.26
- Add support for AMD piledriver insns (#696368)

* Fri Jul 15 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.25
- Fix linker crash handling local symbols in .toc (#721079)

* Tue Jun 28 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.24
- Fix GC of DWARF ranges (#714824)

* Wed Jun  1 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.23
- Add support for new IVB insns (#696494)

* Wed May 25 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.22
- Fix powerpc64 ld "sibling call" error (#707387)

* Tue May 17 2011 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.21
- Copy over OSABI header (#698005)
- Don't set OSABI_LINUX in dynamic ifunc-using executable (#689829)
- Handle non-ASCII in readelf output (#664640)
- Remove unneeded clearing (#674925)
- Handle old ABI calls to new ABI code (#701586)
...
* Wed May  5 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.10
- Avoid generating R_*_NONE (#587788)

* Tue Apr  6 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.9
- Handle DWARF-4 (#578576)

* Tue Apr  6 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.8
- Fix non-zero section address in relocatable link (#579696)

* Tue Apr  6 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.7
- Add BNI support (#576315)

* Wed Mar 24 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.6
- Fix crash building qt (#576129, PR ld/11088)

* Thu Feb 11 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.5
- Fix last change (#561850)

* Wed Feb 10 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.4
- Fix testsuite failures (#561850)

* Tue Jan  5 2010 Andreas Schwab <schwab@redhat.com> - 2.20.51.0.2-5.3
- Fix doc typo (#545384)

* Fri Dec 11 2009 Jakub Jelinek <jakub@redhat.com> 2.20.51.0.2-5.2
- Apply patch for PR 10856.  (BZ 544358)
- Fix permissions of PIEs in objcopy.  (PR binutils/10802)
- Fix readelf -D with DT_RUNPATH.
- Fix PowerPC TLS transitions.  (PR ld/11047)
- Fix order of relocations in IFUNC PowerPC64 objects linked with
  -z nocombreloc.  (PR ld/11012)
- Add AMD Orochi XOP support, some FMA4 support fixes.

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 2.20.51.0.2-5.1
- Rebuilt for RHEL 6
